...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Your new ID", "Tu nuevo ID"),
        ("length %min% to %max%", "tamaño de %min% a %max%"),
        ("starts with a letter", "comienza con una letra"),
        ...
        ("Mute", "Silenciar"),
        ("Build Date", "Fecha de Compilacion"),
        ("Version", "Versión"),
        ("Home", ""),
        ...
        ("Start on Boot", "Ejecutar al Inicio"),
        ("Start the screen sharing service on boot, requires special permissions", "Iniciar el servicio de pantalla compartida en el arranque, requiere permisos especiales"),
        ...
        ("Pin Toolbar", "Anclar barra de herramientas"),
        ("Unpin Toolbar", "Desanclar barra de herramientas"),
        ("Recording", "Grabando"),
